    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-5 col-lg-4">
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle text-muted">{{$users[0]->email}}</h6>
                        <p>Nos gusta el desarrollo de software, pero nos gusta más la clase de TSIC II</p>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-7 col-lg-8">
                ...
                <hr>
                <button class="btn btn-outline-primary btn-block">Contáctanos</button>
            </div>
        </div>
    </div>
@endsection